...
# Build native php for phar to build (seee pear-Makefile.frag.patch):
...
TERMUX_PKG_DEPENDS="freetype, libandroid-glob, libandroid-support, libbz2, libc++, libcrypt, libcurl, libffi, libgd, libgmp, libiconv, libicu, liblzma, libsqlite, libxml2, libxslt, libzip, oniguruma, openssl-1.1, pcre2, readline, tidy, zlib"
